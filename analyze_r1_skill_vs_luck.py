...
def main():
    ...
    create_more_skill_players = lambda: make_player_pool(skill_dist="uniform", skill_dist_params={"min": 1150, "max": 1850})
    simulate_n_rounds("more skill (1150-1850 ELO)", create_more_skill_players, actual_stdev)

    create_lots_of_skill_players = lambda: make_player_pool(skill_dist="uniform", skill_dist_params={"min": 1000, "max": 2000})
    simulate_n_rounds("lots of skill (1000-2000 ELO)", create_lots_of_skill_players, actual_stdev)
